...
module id_r32_field_array_2d_pair_mod
  ...
  !>
  type, public, extends(id_abstract_pair_type) :: id_r32_field_array_2d_pair_type
  ...
  end type id_r32_field_array_2d_pair_type

contains

  !> @brief Initialises the id_r32_field_array_2d_pair object with new fields
  ...
  subroutine initialise(self, fs, id, dim1, dim2, halo_depth)
    ...
    class(id_r32_field_array_2d_pair_type),   intent(inout) :: self
  ...
  !> @brief Initialises the id_r32_field_array_2d_pair object by copying in fields
  ...
  function get_field_array(self) result(field_array)
    ...
    class(id_r32_field_array_2d_pair_type), target, intent(in) :: self
  ...
  subroutine destructor(self)
    implicit none
    type(id_r32_field_array_2d_pair_type), intent(inout) :: self
    integer(kind=i_def) :: i, j
...
end module id_r32_field_array_2d_pair_mod
