...
# sphinx_gallery_thumbnail_path = '_static/fs_thumbnails/wtheta_k0_plane_x.svg'
...
RED = f"rgba(255, 0, 0, {CROSS_OPACITY})"
...
for i in range(len(dof_x)):
    ...
    if dof_planes[i] == "y":
        # y
        # will implement if we like this marker
        pass
    if dof_planes[i] == "x":
        # x
        # will implement if we like this marker
...
# fig.write_image("source/_static/fs_thumbnails/wtheta_k0_plane_x.svg")  # for the thumbnail
