...
# sphinx_gallery_thumbnail_path = '_static/fs_thumbnails/wtheta_k0_sphere.svg'
...
# fig.write_image("source/_static/fs_thumbnails/wtheta_k0_sphere.svg")  # for the thumbnail
